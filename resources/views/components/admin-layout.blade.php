...
<head>
    ...
    <style>
        ...
        .logout-button {
            ...
            top: 1rem;
            right: 1rem;
            background-color: #091970; /* Medium green */
            color: white;
    ...
    <aside id="sidebar-multi-level-sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0  bg-blue-700" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto">
            <div class="text-center flex flex-col items-center">
                <img src="{{asset('images/bbd69978-5f49-4071-a06e-197a7dab01e0-removebg-preview.png')}}" alt="Admin">
                <div class="font-bold   text-white">MARBEL MED CONNECT</div>
            </div>
            <ul class="space-y-2 font-medium mt-4">
                ...
                <li>
                    <a href="{{route('admin.refer')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="text-pink-500 ri-file-add-fill"></i>
                        <span class="ms-3 text-white">Reffered Patients</span>
                    </a>
                </li>

                     <li>
                    <a href="{{route('admin.patients')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="text-pink-500 ri-capsule-fill"></i>
                        <span class="ms-3 text-white">Add Patient</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('admin.users')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="text-pink-500 ri-capsule-fill"></i>
                        <span class="ms-3 text-white">Users</span>
                    </a>
                </li>

                {{-- <li>
                    <a href="" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="text-pink-500 ri-file-history-line"></i>
                        <span class="ms-3 text-white">Settings</span>
                    </a>
                </li> --}}

                <li>
                    <a href="{{route('admin.reports')}}" class="flex items-center p-2 rounded-lg hover:bg-gray-700">
                        <i class="text-pink-500 ri-file-history-line"></i>
                        <span class="ms-3 text-white">Reports</span>
                    </a>
                </li>
